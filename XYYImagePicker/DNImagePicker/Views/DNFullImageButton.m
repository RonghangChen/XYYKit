...
- (UIButton *)fullImageButton
{
    if (nil == _fullImageButton) {
        ...
        [_fullImageButton setImage:[UIImage imageNamed:@"photo_full_image_unselected.png"] forState:UIControlStateNormal];
        [_fullImageButton setImage:[UIImage imageNamed:@"photo_full_image_selected.png"] forState:UIControlStateSelected];
