...
static char UIAlertViewCallBackBlockKey;
...
- (UIAlertViewCallBackBlock)alertViewCallBackBlock {
    return objc_getAssociatedObject(self, &UIAlertViewCallBackBlockKey);
}

- (void)alertView:(UIAlertView *)alertView didDismissWithButtonIndex:(NSInteger)buttonIndex
{
    if (alertView == self) {
        UIAlertViewCallBackBlock alertViewCallBackBlock = self.alertViewCallBackBlock;
        if (alertViewCallBackBlock) {
            alertViewCallBackBlock(self,buttonIndex);
        }
    }
}
